    ...
    <div className='w-[280px] bg-violet-700 flex flex-col justify-between h-screen fixed'>
      <div className="pt-8 gap-8 flex flex-col">
        ...
        <div className="flex flex-col">
          ...
          <Link href={'/dashboard/events'} className={`flex flex-row py-2 px-7 ${
            isActiveEvents() ? 'bg-violet-800' : 'bg-violet-700'
            } gap-3 text-white`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
          ...
          <Link href={'/dashboard/settings'} className={`flex flex-row py-2 px-7 ${isActive('/dashboard/settings') ? 'bg-violet-800' : 'bg-violet-700'} gap-3 text-white`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">

        ...
        <div className="flex gap-8 pb-8 flex-col">
          <div className="flex items-start justify-between gap-4 border-b border-b-gray-200 pb-5 w-full">
            ...
            <div className="flex gap-3 items-center">
              <Link href={`/dashboard/events/edit/${event._id}`} className="rounded-lg border border-gray-300 bg-white py-2.5 px-4 shadow flex gap-2 items-center font-semibold text-sm text-gray-700">
